...
contract DeployConfig {
    ...
    uint256 public constant SETTLEMENT_TOKEN_BALANCE_CAP = 10000000;
    ...
    // LimitOrderBook
    string internal constant _EIP_712_NAME = "PerpCurieLimitOrder";
    string internal constant _EIP_712_VERSION = "1";
}
